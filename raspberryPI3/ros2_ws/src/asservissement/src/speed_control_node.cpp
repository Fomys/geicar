#include "../include/speed_control/speed_control_node.h"

using namespace std;
using placeholders::_1;

//class speed_control_node : public rclcpp::Node{
//
//public:
//    speed_control_node():Node("speed_control_node")
//    {
//
...
//        RCLCPP_INFO(this->get_logger(), "speed_control_node READY");
//    }
//
//private:
//
